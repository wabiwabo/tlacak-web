...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex w-fit items-center justify-between gap-2 border border-input bg-card/40 px-3 py-2 text-sm whitespace-nowrap',
        'font-mono tracking-wide text-foreground',
        'transition-[color,box-shadow,border-color] outline-none',
        'hover:border-primary/50',
        'focus-visible:border-primary focus-visible:shadow-[0_0_0_1px_rgba(0,255,200,0.45),0_0_14px_rgba(0,255,200,0.18)]',
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'shadow-[0_0_0_1px_rgba(0,255,200,0.06),0_20px_60px_rgba(0,0,0,0.6)]',
